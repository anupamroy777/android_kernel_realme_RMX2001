...
#define CLATM_INIT_CFG_0_MAX_CPU_PWR		(3980)
...
#define CLATM_INIT_CFG_1_MAX_CPU_PWR		(3980)
...
#define CLATM_INIT_CFG_2_FIRST_STEP		(3980)
...
#define CLATM_INIT_CFG_2_MAX_GPU_PWR		(2060)

#define CLATM_INIT_CFG_ACTIVE_ATM_COOLER	(0)

#define CLATM_INIT_CFG_CATM			(0)

#define CLATM_INIT_CFG_PHPB_CPU_TT		(12)
#define CLATM_INIT_CFG_PHPB_CPU_TP		(12)
