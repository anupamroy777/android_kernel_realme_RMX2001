...
#define TZCPU_INITCFG_TRIP_2_TEMP		(97000)
#define TZCPU_INITCFG_TRIP_2_COOLER		"cpu03"

#define TZCPU_INITCFG_TRIP_3_TEMP		(92000)
#define TZCPU_INITCFG_TRIP_3_COOLER		"cpu_adaptive_0"

#define TZCPU_INITCFG_TRIP_4_TEMP		(88000)
#define TZCPU_INITCFG_TRIP_4_COOLER		""

#define TZCPU_INITCFG_TRIP_5_TEMP		(84000)
#define TZCPU_INITCFG_TRIP_5_COOLER		""

#define TZCPU_INITCFG_TRIP_6_TEMP		(82000)
#define TZCPU_INITCFG_TRIP_6_COOLER		""

#define TZCPU_INITCFG_TRIP_7_TEMP		(79500)
#define TZCPU_INITCFG_TRIP_7_COOLER		""

#define TZCPU_INITCFG_TRIP_8_TEMP		(79000)
#define TZCPU_INITCFG_TRIP_8_COOLER		""

#define TZCPU_INITCFG_TRIP_9_TEMP		(77000)
